...
public class MangadevModGameRules {
	...
	public static final GameRules.Key<GameRules.BooleanValue> TWEET_CHAT_OUTPUT = GameRules.register("tweetChatOutput", GameRules.Category.CHAT, GameRules.BooleanValue.create(false));
}
